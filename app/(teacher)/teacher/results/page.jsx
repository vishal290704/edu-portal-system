...
import TeacherResultFilters from "@/components/teacher/TeacherResultFilters";
...
import { getTeacherStudentResult } from "@/app/actions/resultActions";
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            View results of students from your class.
          </p>
        </div>
